...
<head>
    ...
    <link rel="icon" href="https://onthevouch.com/public/management/images/log.png"
          type="image/x-icon">
    <!-- Plugins Core Css -->
...
<div class="page-loader-wrapper">
    <div class="loader">
        <div class="m-t-30">
            <img class="loading-img-spin" src="{{asset('management/images/reload.png')}}" width="20" height="20" alt="admin">
        </div>
        <p>Please wait...</p>
    </div>
</div>
